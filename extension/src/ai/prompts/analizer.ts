...
| User asks to **implement**, **add**, **update**, **refactor**, **fix**, or **remove** code | ❌ No | Return { "nextStep": true } |
...
✅ Response:
The "getUserData" function retrieves user information from the database and returns an object with id, name, and email fields.
